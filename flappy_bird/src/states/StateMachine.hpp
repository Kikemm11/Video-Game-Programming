...
public:
    ...
    void change_state(const std::string& state_name, std::string from_state = "", std::shared_ptr<World> world = nullptr, std::shared_ptr<Bird> bird = nullptr, std::shared_ptr<GameMode> game_mode = nullptr) noexcept;
